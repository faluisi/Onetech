table 50002 VendorLEM
{
    Caption = 'Vendor Ledger Entry Multicompany';
    ...
    fields
    {
        field(1; "Entry No."; Integer)//si
        {
            Caption = 'Entry No.';
        }
        field(1000; Company; Text[30]) // si
        {
            Caption = 'Company';
        }
        field(3; "Vendor No."; Code[20])//si
        {
            Caption = 'Vendor No.';
            TableRelation = Vendor;
        }
        field(4; "Posting Date"; Date) //si
        {
            Caption = 'Posting Date';
        }
        field(5; "Document Type"; Enum "Gen. Journal Document Type") //si
        {
            Caption = 'Document Type';
        }
        field(6; "Document No."; Code[20])//si
        {
            Caption = 'Document No.';
        ...
        field(7; Description; Text[100]) //si
        {
            Caption = 'Description';
        }
        field(8; "Vendor Name"; Text[100])//si
        {
            Caption = 'Vendor Name';
        }
        field(11; "Currency Code"; Code[10]) //si
        {
            Caption = 'Currency Code';
            TableRelation = Currency;
        }
        field(13; Amount; Decimal)//si
        {
        ...
        field(14; "Remaining Amount"; Decimal)//si
        {
            AutoFormatExpression = "Currency Code";
            AutoFormatType = 1;
        ...
        field(33; "On Hold"; Code[3])
        {
            ...
            begin
                if "On Hold" = xRec."On Hold" then
                    exit;
                GenJournalLine.ChangeCompany(rec.Company);
        ...
        field(36; Open; Boolean)//si
        {
            Caption = 'Open';
        }
        field(37; "Due Date"; Date) // si
        {
            Caption = 'Due Date';
        ...
        field(50025; "Default Bank Account"; Code[20])//si
        {
        ...
        field(50001; "approved date"; DateTime)//si
        {
            Caption = 'Finance Approved Date';
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(50002; "approved user"; Text[50])//si
        {
        ...
        field(50003; "Approver Comment"; Text[50])//si
        {
    ...
    keys
    {
        ...
        key(Key3; Company, "Vendor No.", "Currency Code", "Posting Date")
        {
            Enabled = false;
        }
        key(Key4; Company, "Document No.")
        {
        }
        ...
        key(Key18; Company, "Document Type", "Due Date", Open)
        {
        }
    ...
    begin
        ...
        case "Document Type" of
            ...
            "Document Type"::"Credit Memo":
                begin
                    PurchCrMemoHdr.ChangeCompany(rec.Company);
    ...
    var
        VendLedgEntry: Record VendorLEM;
        DrillDownPageID: Integer;
    begin
        VendLedgEntry.Reset();
        DtldVendLedgEntry.ChangeCompany(rec.Company);
    ...
    local procedure OnAfterCopyVendLedgerEntryFromGenJnlLine(var VendorLedgerEntry: Record VendorLEM; GenJournalLine: Record "Gen. Journal Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyVendLedgerEntryFromCVLedgEntryBuffer(var VendorLedgerEntry: Record VendorLEM; CVLedgerEntryBuffer: Record "CV Ledger Entry Buffer")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterRecalculateAmounts(var VendorLedgerEntry: Record VendorLEM; FromCurrencyCode: Code[10]; ToCurrencyCode: Code[10]; PostingDate: Date)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterShowDoc(var VendorLedgerEntry: Record VendorLEM)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterShowPostedDocAttachment(var VendorLedgerEntry: Record VendorLEM)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterHasPostedDocAttachment(var VendorLedgerEntry: Record VendorLEM; var HasPostedDocumentAttachment: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeDrillDownEntries(var VendorLedgerEntry: Record VendorLEM; var DetailedVendorLedgEntry: Record "Detailed Vendor Ledg. Entry"; var DrillDownPageID: Integer)
    begin
    end;

    [IntegrationEvent(true, false)]
    local procedure OnBeforeDrillDownOnOverdueEntries(var VendorLedgerEntry: Record VendorLEM; var DetailedVendorLedgEntry: Record "Detailed Vendor Ledg. Entry"; var DrillDownPageID: Integer)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeValidateMessagetoRecipient(var VendorLedgerEntry: Record VendorLEM; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeShowDoc(var VendorLedgerEntry: Record VendorLEM; var Result: Boolean; var IsHandled: Boolean)
    begin
    end;
