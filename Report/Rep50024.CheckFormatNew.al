...

{
    ...
    dataset
    {
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            column(ChooseCheckFormat; ChooseCheckFormat)
            {
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                column(CheckDateTextOtherFormat; CheckDateTextOtherFormat)
                {
                ...
                dataitem(PrintSettledLoop; "Integer")
                {
                    ...
                    column(paymentreference; GenJnlLine."Payment Reference")
                    {
                    ...
                    column(balaccountno; GenJnlLine."Bal. Account No.")
                    {

                        AutoFormatType = 1;
                    }
                    column(accountno; GenJnlLine."Account No.")
                    {
            ...
            begin
                ...
                if not TestPrint then begin
                    ...
                    //CheckDateText := Format("Posting Date", 0, '<Standard Format,1>');
                    CheckDateText := Format("Posting Date", 0, '<Month,2>/<Day,2>/<Year4>');
                    CheckDateTextOtherFormat := Format("Posting Date", 0, '<Month Text> <Closing><Day>, <Year4>');
                end else begin
