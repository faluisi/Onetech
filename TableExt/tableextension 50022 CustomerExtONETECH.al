    ...
    fields
    {
        field(60100; "Current Month"; Decimal)
        {
            ...
            CalcFormula = Sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" WHERE("Customer No." = FIELD("No."),
                                                                                 ...
                                                                                 "Initial Entry Due Date" = FIELD("0D Date Filter")));
        ...
        field(60101; "1 Month"; Decimal)
        {
            ...
            CalcFormula = Sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" WHERE("Customer No." = FIELD("No."),
                                                                                 ...
                                                                                 "Posting Date" = FIELD("Date Filter"),
                                                                                 "Initial Document Type" = FILTER("Invoice"),
                                                                                 "Initial Entry Due Date" = FIELD("30D Date Filter")));
            Caption = '1 Month';
        ...
        field(60102; "2 Months"; Decimal)
        {
            ...
            CalcFormula = Sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" WHERE("Customer No." = FIELD("No."),
                                                                                 ...
                                                                                 "Posting Date" = FIELD("Date Filter"),
                                                                                 "Initial Document Type" = FILTER("Invoice"),
                                                                                 "Initial Entry Due Date" = FIELD("60D Date Filter")));
            Caption = '2 Months';
        ...
        field(60103; "3 Months"; Decimal)
        {
            ...
            CalcFormula = Sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" WHERE("Customer No." = FIELD("No."),
                                                                                 ...
                                                                                 "Posting Date" = FIELD("Date Filter"),
                                                                                 "Initial Document Type" = FILTER("Invoice"),
                                                                                 "Initial Entry Due Date" = FIELD("90D Date Filter")));
            Caption = '3 Months';
        ...
        field(60104; "4 Months"; Decimal)
        {
            ...
            CalcFormula = Sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" WHERE("Customer No." = FIELD("No."),
                                                                                 ...
                                                                                 "Posting Date" = FIELD("Date Filter"),
                                                                                 "Initial Document Type" = FILTER("Invoice"),
                                                                                 "Initial Entry Due Date" = FIELD("120D Date Filter")));
            Caption = '4 Months';
        ...
        field(60105; "5 Months"; Decimal)
        {
            ...
            CalcFormula = Sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" WHERE("Customer No." = FIELD("No."),
                                                                                 ...
                                                                                 "Posting Date" = FIELD("Date Filter"),
                                                                                 "Initial Document Type" = FILTER("Invoice"),
                                                                                 "Initial Entry Due Date" = FIELD("150D Date Filter")));
            Caption = '5 Months';
        ...
        field(60106; "6 Months"; Decimal)
        {
            ...
            CalcFormula = Sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" WHERE("Customer No." = FIELD("No."),
                                                                                 ...
                                                                                 "Posting Date" = FIELD("Date Filter"),
                                                                                 "Initial Document Type" = FILTER("Invoice"),
                                                                                 "Initial Entry Due Date" = FIELD("180D Date Filter")));
            Caption = '6 Months';
        ...
        field(50101; "7 Months"; Decimal)
        {
            ...
            CalcFormula = Sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" WHERE("Customer No." = FIELD("No."),
                                                                                 ...
                                                                                 "Posting Date" = FIELD("Date Filter"),
                                                                                 "Initial Document Type" = FILTER("Invoice"),
                                                                                 "Initial Entry Due Date" = FIELD("210D Date Filter")));
            Caption = '7 Months';
        ...
        field(50102; "8 Months"; Decimal)
        {
            ...
            CalcFormula = Sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" WHERE("Customer No." = FIELD("No."),
                                                                                 ...
                                                                                 "Posting Date" = FIELD("Date Filter"),
                                                                                 "Initial Document Type" = FILTER("Invoice"),
                                                                                 "Initial Entry Due Date" = FIELD("240D Date Filter")));
            Caption = '8 Months';
        ...
        field(50103; "9 Months"; Decimal)
        {
            ...
            CalcFormula = Sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" WHERE("Customer No." = FIELD("No."),
                                                                                 ...
                                                                                 "Posting Date" = FIELD("Date Filter"),
                                                                                 "Initial Document Type" = FILTER("Invoice"),
                                                                                 "Initial Entry Due Date" = FIELD("270D Date Filter")));
            Caption = '9 Months';
        ...
        field(50104; "10 Months"; Decimal)
        {
            ...
            CalcFormula = Sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" WHERE("Customer No." = FIELD("No."),
                                                                                 ...
                                                                                 "Posting Date" = FIELD("Date Filter"),
                                                                                 "Initial Document Type" = FILTER("Invoice"),
                                                                                 "Initial Entry Due Date" = FIELD("300D Date Filter")));
            Caption = '10 Months';
        ...
        field(50105; "11 Months"; Decimal)
        {
            ...
            CalcFormula = Sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" WHERE("Customer No." = FIELD("No."),
                                                                                 ...
                                                                                 "Posting Date" = FIELD("Date Filter"),
                                                                                 "Initial Document Type" = FILTER("Invoice"),
                                                                                 "Initial Entry Due Date" = FIELD("330D Date Filter")));
            Caption = '11 Months';
        ...
        field(50106; "12 Months"; Decimal)
        {
            ...
            CalcFormula = Sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" WHERE("Customer No." = FIELD("No."),
                                                                                 ...
                                                                                 "Posting Date" = FIELD("Date Filter"),
                                                                                 "Initial Document Type" = FILTER("Invoice"),
                                                                                 "Initial Entry Due Date" = FIELD("360D Date Filter")));
            Caption = '12 Months';
        ...
        field(60118; "Amounts Not Due"; Decimal)
        {
            ...
            CalcFormula = Sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" WHERE("Customer No." = FIELD("No."),
                                                                                 ...
                                                                                 "Initial Entry Due Date" = FIELD("Future Date Filter")));
            Caption = 'Current Month';
            Description = 'ONETECH Current Month-30D';
            Editable = false;
            FieldClass = FlowField;
