report 50006 OnetechSalesReport
{
    ...
    dataset
    {
        dataitem(salesinvoiceline; "Sales Invoice Line")
        {
            ...
            column(invperiodstart; "Period Start")
            {

            }
            column(invperiodend; "Period End")
            {
            ...
            begin
                ...
                if ("Period Start" <> 0D) and ("Period End" <> 0D) then begin
                    ...
                    PeriodEndday := DATE2DMY("Period End", 1);
        ...
        dataitem(salescrmemoline; "Sales Cr.Memo Line")
        {
            ...
            column(crmemoperiodstart; "Period Start")
            {

            }
            column(crmemoperiodend; "Period End")
            {
